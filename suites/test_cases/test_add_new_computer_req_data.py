...
class test_add_new_computer_req_data(unittest.TestCase):
    ...
    def test_add_new_computer_req_data(self):
        ...
        print('*****************TC:test_add_new_computer_req_data*******************')
        ...
        self.new_computer = dataComputer['new_computer_req_data']
        ...
        # ADD A COMPUTER PAGE
        today_date = str(datetime.datetime.now(pytz.timezone('US/Pacific')).strftime('%m-%d %H:%M:%S'))
        self.new_comp_req_data = self.new_computer + today_date
        callAddNewComputerPage = AddNewComputerPage(callWDriver.driver, self.new_comp_req_data, '', '')
        ...
        val_create_computer = callAddNewComputerPage.create_computer()
        # assert is != to False, expecting True to check true of test value as computer created
        assert val_create_computer != False, 'Create Computer Failed'
